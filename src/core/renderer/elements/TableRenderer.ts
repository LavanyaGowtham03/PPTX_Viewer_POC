import type { TableCell, TableElement } from '../../models/pptx-models';
...
const renderCell = (cell: TableCell): HTMLTableCellElement => {
 ...
 */
export function renderTable(el: TableElement, scale: number): HTMLElement {
