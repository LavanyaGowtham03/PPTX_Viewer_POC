 ...
 */
export function renderWelcomeScreen(container, onLoad) {
    container.innerHTML = '';
    // ── Card structure ────────────────────────────────────────────
    ...
    const readFile = (file) => {
        ...
        reader.onload = () => validateAndLoad(String(reader.result ?? ''));
        reader.onerror = () => showInlineError(INVALID_FILE_MESSAGE);
